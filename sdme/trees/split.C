...
void Split(std::string inf_name, std::string data, std::string dir, int n_threads = 4, std::string ext = "", std::string filter = "", bool verbose = false);
...
void Split(std::string inf_name, std::string data, std::string dir, int n_threads = 4, std::string ext = "", std::string filter = "", bool verbose = false) {
	...
	dat000.Snapshot("kin", (dir+"/"+data+"_"+ext+"_000.root").c_str(), branches);
	dat045.Snapshot("kin", (dir+"/"+data+"_"+ext+"_045.root").c_str(), branches);
	dat090.Snapshot("kin", (dir+"/"+data+"_"+ext+"_090.root").c_str(), branches);
	dat135.Snapshot("kin", (dir+"/"+data+"_"+ext+"_135.root").c_str(), branches);
	...
	if(data == "dat") {
		...
		bkg000.Snapshot("kin", (dir+"/bkg_"+ext+"_000.root").c_str(), branches);
		bkg045.Snapshot("kin", (dir+"/bkg_"+ext+"_045.root").c_str(), branches);
		bkg090.Snapshot("kin", (dir+"/bkg_"+ext+"_090.root").c_str(), branches);
		bkg135.Snapshot("kin", (dir+"/bkg_"+ext+"_135.root").c_str(), branches);
