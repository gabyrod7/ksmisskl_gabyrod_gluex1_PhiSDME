...
void plotTopology() {
	...
	TFile *f = TFile::Open("hist_bggen_2.root");
	...
	for(int i=0; i<locNumTopologies; i++) {
		...
		//TH1I *hMassThrownTopology = (TH1I*)f->Get(Form("hPiPiInvariantMass_ThrownTopology_%d", i));
		//TH1I *hMassThrownTopology = (TH1I*)f->Get(Form("hMissingMass_ThrownTopology_%d", i));
		TH1I *hMassThrownTopology = (TH1I*)f->Get(Form("hPathLength_ThrownTopology_%d", i));
