void UnusedTracks2() {
	...
	auto h1 = (TH1F*)inf1->Get("NumUnusedTracks_charged_showercut");
	auto h2 = (TH1F*)inf2->Get("NumUnusedTracks_showercut");
	auto h3 = (TH1F*)inf1->Get("NumUnusedTracks_mixed_showercut");
	auto h4 = (TH1F*)inf1->Get("NumUnusedTracks_0_showercut");
...
//	t.DrawLatex(1.5, 0.6*h1->GetMaximum(), "K_{S}K_{S}p #rightarrow other channels");
	...
	c->SaveAs("unsued_tracks_study2.pdf");

	cout << "efficiency " << h1->Integral(1, 1, "width") << endl;
}
